...
startgame.prototype.barValueUp = function() {
    this.Bar.incCurrentValue(10);
    this.Bar2.incCurrentValue(10);
};

startgame.prototype.barValueDown = function(){
    this.Bar.incCurrentValue(-10);
    this.Bar2.incCurrentValue(-10);
};
...
startgame.prototype.barSelect = function(){
    this.demoSelect=1;
};

startgame.prototype.sliderSelect = function() {
    this.demoSelect=2;
};

startgame.prototype.toggleSelect = function() {
    this.demoSelect=3;
};
